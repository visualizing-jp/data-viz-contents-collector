import { createPublisher } from "@/lib/actions/publishers";
  ...
  return (
    <div className="max-w-lg">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold">新規パブリッシャー登録</h1>
      </div>

      <form action={createPublisher} className="rounded-lg border border-gray-200 bg-white p-6 space-y-5">
        <div>
          ...
          <input
            ...
            type="text"
            required
            placeholder="例: The New York Times Graphics"
